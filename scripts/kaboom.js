var kaboom = (() => {
   ...
   var jt = (i, t, l) =>
         t in i
            ...
            : (i[t] = l),
      P = (i, t) => {
         for (var l in t || (t = {})) sr.call(t, l) && jt(i, l, t[l]);
         if (ir) for (var l of ir(t)) es.call(t, l) && jt(i, l, t[l]);
         return i;
      },
      D = (i, t) => zi(i, Qi(t)),
      ts = (i) => Ve(i, "__esModule", { value: !0 }),
      a = (i, t) => Ve(i, "name", { value: t, configurable: !0 });
   var ns = (i, t) => {
         for (var l in t) Ve(i, l, { get: t[l], enumerable: !0 });
      },
      rs = (i, t, l, w) => {
         if ((t && typeof t == "object") || typeof t == "function")
            for (let U of Zi(t))
               !sr.call(i, U) &&
                  ...
                  Ve(i, U, {
                     get: () => t[U],
                     enumerable: !(w = Ji(t, U)) || w.enumerable,
                  });
         return i;
      };
   var is = (
      (i) => (t, l) =>
         (i && i.get(t)) || ((l = rs(ts({}), t, 1)), i && i.set(t, l), l)
   )(typeof WeakMap != "undefined" ? new WeakMap() : 0);
   var b = (i, t, l) => (jt(i, typeof t != "symbol" ? t + "" : t, l), l);
   var or = (i, t, l) =>
      new Promise((w, U) => {
         var p = (q) => {
               try {
            ...
            A = (q) =>
               q.done ? w(q.value) : Promise.resolve(q.value).then(p, S);
         A((l = l.apply(i, t)).next());
      });
   var ar = (() => {
      for (var i = new Uint8Array(128), t = 0; t < 64; t++)
         i[t < 26 ? t + 65 : t < 52 ? t + 71 : t < 62 ? t - 4 : t * 4 - 205] =
            t;
      return (l) => {
         for (
            var w = l.length,
      ...
      if (l === "object" && w === "object") {
         ...
         for (let S of U) {
            let A = i[S],
               q = t[S];
            if (
               !(typeof A == "function" && typeof q == "function") &&
               !Yt(A, q)
            )
               return !1;
         }
   ...
   function B(i, t) {
      ur.has(i) ||
         (ur.add(i), console.warn(`${i} is deprecated. Use ${t} instead.`));
   }
   a(B, "deprecateMsg");
   var T = a(
      (i, t, l) =>
   ...
   a(Fe, "lerp");
   function ft(i, t, l, w, U) {
      return w + ((i - t) / (l - t)) * (U - w);
   }
   a(ft, "map");
   function fr(i, t, l, w, U) {
      return z(ft(i, t, l, w, U), w, U);
   }
   a(fr, "mapc");
   var N = class {
         constructor(t = 0, l = t) {
         ...
         lerp(t, l) {
            return new N(Fe(this.x, t.x, l), Fe(this.y, t.y, l));
         }
         toFixed(t) {
   ...
   a(ke, "Vec3");
   var de = a((i, t, l) => new ke(i, t, l), "vec3"),
      ue = class {
         constructor(t, l, w) {
            b(this, "r", 255);
            b(this, "g", 255);
         ...
         str() {
            return (
               B("str()", "toString()"), `(${this.r}, ${this.g}, ${this.b})`
            );
         }
         toString() {
   ...
   a(E, "rgb");
   var pr = a((i, t, l) => v.fromHSL(i, t, l), "hsl2rgb"),
      k = class {
         constructor(t, l, w, U) {
            b(this, "x", 0);
            b(this, "y", 0);
   ...
   var R = class {
      ...
      invert() {
         let t = [],
            ...
            un = this.m[5] * this.m[15] - this.m[13] * this.m[7],
            vt = this.m[4] * this.m[13] - this.m[12] * this.m[5],
            Et = this.m[6] * this.m[11] - this.m[10] * this.m[7],
            ...
            Xe = this.m[4] * this.m[9] - this.m[8] * this.m[5];
         (t[0] = this.m[5] * l - this.m[6] * w + this.m[7] * U),
            ...
            (t[10] = this.m[0] * un - this.m[1] * X + this.m[3] * vt),
            (t[14] = -(this.m[0] * j - this.m[1] * Y + this.m[2] * vt)),
            (t[3] = -(this.m[1] * Et - this.m[2] * ve + this.m[3] * Ee)),
            (t[7] = this.m[0] * Et - this.m[2] * Te + this.m[3] * J),
            (t[11] = -(this.m[0] * ve - this.m[1] * Te + this.m[3] * Xe)),
            (t[15] = this.m[0] * Ee - this.m[1] * J + this.m[2] * Xe);
         let Tt =
            this.m[0] * t[0] +
            this.m[1] * t[4] +
            this.m[2] * t[8] +
         ...
         for (let Se = 0; Se < 4; Se++)
            for (let Ce = 0; Ce < 4; Ce++) t[Se * 4 + Ce] *= 1 / Tt;
         return new R(t);
      }
      toString() {
   ...
   var ss = 1103515245,
      ...
      be = class {
         ...
         gen(...t) {
            if (t.length === 0)
               return (this.seed = (ss * this.seed + os) % dr), this.seed / dr;
            if (t.length === 1) {
   ...
   a(xr, "testRectCircle");
   function mt(i, t) {
      return gt(t, [i.p1, f(i.p2.x, i.p1.y), i.p2, f(i.p1.x, i.p2.y)]);
   }
   a(mt, "testRectPolygon");
   function vr(i, t) {
      return !1;
   }
   a(vr, "testLinePoint");
   ...
   a(Be, "testLinePolygon");
   function wt(i, t) {
      return i.center.dist(t) < i.radius;
   }
   a(wt, "testCirclePoint");
   function Zt(i, t) {
   ...
   a(gt, "testPolygonPolygon");
   function xe(i, t) {
      let l = !1;
      for (let w = 0, U = i.length - 1; w < i.length; U = w++)
         i[w].y > t.y != i[U].y > t.y &&
            t.x <
               ((i[U].x - i[w].x) * (t.y - i[w].y)) / (i[U].y - i[w].y) +
                  i[w].x &&
            (l = !l);
      return l;
   }
   ...
   var Dr = {
      ...
      Ar = ["left", "middle", "right", "back", "forward"],
      ws = [
         "space",
         "left",
         "right",
...
`,
      Ss = new Set(["id", "require"]),
      Cs = new Set(["add", "load", "update", "draw", "destroy", "inspect"]);
   function Gr(i) {
   ...
   var Ls = a((i = {}) => {
      let t = (() => {
         ...
         l = (() => {
            ...
            e.bindBuffer(e.ARRAY_BUFFER, c),
               e.vertexAttribPointer(0, 3, e.FLOAT, !1, Ye * 4, 0),
               e.enableVertexAttribArray(0),
               e.vertexAttribPointer(1, 2, e.FLOAT, !1, Ye * 4, 12),
               e.enableVertexAttribArray(1),
               e.vertexAttribPointer(2, 4, e.FLOAT, !1, Ye * 4, 20),
               e.enableVertexAttribArray(2),
               e.bufferData(e.ARRAY_BUFFER, xt * 4, e.DYNAMIC_DRAW),
               e.bindBuffer(e.ARRAY_BUFFER, null);
            let s = e.createBuffer();
            e.bindBuffer(e.ELEMENT_ARRAY_BUFFER, s),
               e.bufferData(e.ELEMENT_ARRAY_BUFFER, xt * 2, e.DYNAMIC_DRAW),
      ...
      function X(e, n, r, u, c = {}) {
         return S(
            j(n).then((s) => {
               var d;
               let o = jr(He(s, c), r, u, (d = c.chars) != null ? d : Or);
         ...
         return S(
            new Promise((r, u) => {
               V(n)
                  .then((c) => c.json())
                  .then((c) =>
                     or(this, null, function* () {
                        let s = yield Promise.all(c.frames.map(j)),
                           o = document.createElement("canvas");
                        (o.width = c.width),
                           (o.height = c.height * c.frames.length);
            ...
            new Promise((r, u) => {
               ...
               typeof n == "string" &&
                  V(n)
                     ...
                     .then(
                        (c) =>
                           new Promise((s, o) => w.ctx.decodeAudioData(c, s, o))
                     )
                     .then((c) => {
                        let s = { buf: c };
                        e && (U.sounds[e] = s), r(s);
      ...
      function Nr(e) {
         return (
            e !== void 0 && (w.masterNode.gain.value = z(e, Ir, Vr)),
      ...
      function Ke(
         e,
         n = { loop: !1, volume: 1, speed: 1, detune: 0, seek: 0 }
      ) {
         var g;
         if (typeof e == "string") {
            let y = Ke({ buf: _r() });
         ...
         let d = r.currentTime - o,
            ...
            m = {
               ...
               speed(y) {
                  return (
                     y !== void 0 && (c.playbackRate.value = z(y, Us, ys)),
                     c.playbackRate.value
                  );
               },
               detune(y) {
                  return c.detune
                     ? (y !== void 0 && (c.detune.value = z(y, bs, xs)),
                       c.detune.value)
                     : 0;
               },
               volume(y) {
                  return (
                     y !== void 0 && (s.gain.value = z(y, Ir, Vr)), s.gain.value
                  );
               },
               loop() {
                  c.loop = !0;
      ...
      a(He, "makeTex");
      function ln(e = on, n = an) {
         let r = t.gl,
            u,
            c = Es.replace("{{user}}", e != null ? e : on),
            s = Ts.replace("{{user}}", n != null ? n : an),
...
`)
      ...
      a(jr, "makeFont");
      function St(e, n, r, u = l.defTex, c = l.defShader, s = {}) {
         (u = u != null ? u : l.defTex),
            (c = c != null ? c : l.defShader),
            (u !== l.curTex ||
               c !== l.curShader ||
               !Yt(l.curUniform, s) ||
               l.vqueue.length + e.length * Ye > xt ||
               l.iqueue.length + n.length > xt) &&
               hn();
         for (let o of e) {
            let d = r ? l.transform : p.cam.transform.mult(l.transform),
               h = Yr(d.multVec2(o.pos.xy()));
            l.vqueue.push(
               h.x,
               h.y,
               o.pos.z,
         ...
         for (let o of n) l.iqueue.push(o + l.vqueue.length / Ye - e.length);
         ...
         t.gl.clear(t.gl.COLOR_BUFFER_BIT),
            i.background ||
               pe({
                  width: F(),
                  height: G(),
                  quad: new k(0, 0, (F() * t.scale) / kr, (G() * t.scale) / kr),
                  tex: l.bgTex,
                  fixed: !0,
               }),
            (l.drawCalls = 0),
      ...
      a(ze, "frameStart");
      function Je() {
         hn(), (l.lastDrawCalls = l.drawCalls);
      }
      a(Je, "frameEnd");
      function Ps() {
      ...
      function pe(e) {
         ...
         let n = e.width,
            r = e.height,
            c = $e(e.origin || je).scale(f(n, r).scale(-0.5)),
      ...
      function dn(e) {
         ...
         let n = Un(e.sprite, U.sprites);
         if (!n)
            if (typeof e.sprite == "string") {
               Ct.has(e.sprite) ||
                  (Ct.add(e.sprite),
                  J(e.sprite, e.sprite).then((s) => Ct.delete(e.sprite)));
               return;
            } else throw new Error(`sprite not found: "${e.sprite}"`);
         let r = n.frames[(u = e.frame) != null ? u : 0];
         if (!r)
            throw new Error(
               `frame not found: ${(c = e.frame) != null ? c : 0}`
            );
         $r(
            D(P({}, e), {
               tex: n.tex,
      ...
      function We(e) {
         ...
         St(s, [0, 1, 3, 1, 2, 3], e.fixed, l.defTex, e.shader, e.uniform);
      }
      a(We, "drawLine");
      function fn(e) {
         let n = e.pts;
      ...
      function Rt(e) {
         ...
         e.radius !== 0 &&
            mn(D(P({}, e), { radiusX: e.radius, radiusY: e.radius, angle: 0 }));
      }
      a(Rt, "drawCircle");
      function mn(e) {
         var n, r;
      ...
      a(wn, "applyCharTransform");
      let gn = /\[(?<text>[^\]]*)\]\.(?<style>[\w\.]+)+/g;
      function Xr(e) {
         let n = {},
            r = e.replace(gn, "$1"),
            u = 0;
         for (let c of e.matchAll(gn)) {
      ...
      function me(e) {
         ...
         let n = Un((Zn = e.font) != null ? Zn : i.font, U.fonts, vs);
         if (!n) throw new Error(`Font not found: ${e.font}`);
         let { charStyleMap: r, text: u } = Xr(e.text + ""),
            c = u.split(""),
            s = n.qw * n.tex.width,
            o = n.qh * n.tex.height,
            d = e.size || o,
            h = f(d / o).scale(f(e.scale || 1)),
            m = h.x * s + ((er = e.letterSpacing) != null ? er : 0),
            g = h.y * o + ((tr = e.lineSpacing) != null ? tr : 0),
            y = 0,
            x = g,
            W = 0,
            O = [],
...
` && (M.push(oe), (y += m), oe === " " && (ee = M.length)),
         ...
         let Ae = [],
            Oe = f(e.pos || 0),
            _ = $e(e.origin || je).scale(0.5),
            se = -_.x * m - (_.x + 0.5) * (W - m),
            Ie = -_.y * g - (_.y + 0.5) * (x - g),
            ct = 0;
         return (
            O.forEach((oe, Ni) => {
               let ji = (W - oe.length * m) * (_.x + 0.5);
               oe.forEach((lt, Yi) => {
                  var nr;
                  let _t = n.map[lt],
                     $i = Yi * m,
                  ...
                  if (_t) {
                     let Bt = {
                        tex: n.tex,
                        quad: new k(_t.x, _t.y, n.qw, n.qh),
                        ch: lt,
                        pos: f(Oe.x + $i + se + ji, Oe.y + Xi + Ie),
                        opacity: e.opacity,
                        color: (nr = e.color) != null ? nr : E(255, 255, 255),
                        scale: h,
                        angle: 0,
                        uniform: e.uniform,
                        fixed: e.fixed,
                     ...
                     if (r[ct]) {
                        let { styles: ht, localIdx: Ki } = r[ct];
                        for (let Hi of ht) {
                           let Nt = e.styles[Hi],
                              rr = typeof Nt == "function" ? Nt(Ki, lt) : Nt;
                           rr && wn(Bt, rr);
                        }
                     }
                     Ae.push(Bt);
      ...
      a(G, "height"),
         t.canvas.addEventListener("mousemove", (e) => {
            (t.mousePos = f(
               ...
               (t.mouseDeltaPos = f(e.movementX, e.movementY).scale(
                  1 / t.scale
               )),
               (t.isMouseMoved = !0);
         }),
         ...
         t.canvas.addEventListener("keydown", (e) => {
            let n = Dr[e.key] || e.key.toLowerCase();
            ws.includes(n) && e.preventDefault(),
      ...
      let C = {
         ...
         clearLog: () => (p.logs = []),
         log: (e) => p.logs.unshift(`[${rt().toFixed(2)}].time [${e}].info`),
         error: (e) => p.logs.unshift(`[${rt().toFixed(2)}].time [${e}].error`),
         curRecording: null,
         get paused() {
            return t.paused;
         },
      ...
      a(Z, "dt");
      function Qr() {
         return B("mouseWorldPos()", "toWorld(mousePos())"), qt(K());
      }
      a(Qr, "mouseWorldPos");
      function Zr(e, n) {
         e.forEach((r, u) => {
         ...
         let n = new Map(),
            ...
            c = {
               ...
               action(...s) {
                  return (
                     console.warn(
                        "action() is deprecated. Use onUpdate() instead"
                     ),
                     this.onUpdate(...s)
                  );
               },
      ...
      a(Dt, "onKeyPressRepeat");
      function At(e, n) {
         if (Array.isArray(e)) {
            let r = e.map((u) => At(u, n));
            return () => r.forEach((u) => u());
         } else
            return typeof e == "function"
               ? p.on("input", () => nt() && e())
      ...
      a(qn, "onMouseRelease");
      function Pn(e) {
         return p.on("input", () => Wt() && e(K(), bn()));
      }
      a(Pn, "onMouseMove");
      function Dn(e) {
         return p.on("input", () => Hr().forEach((n) => e(n)));
      }
      a(Dn, "onCharInput");
      function An(e) {
               ...
               return (
                  ...
                  s &&
                     ...
                     s.target.trigger(
                        "collide",
                        this,
                        Gn(this, s.displacement.scale(-1))
                     )),
                  s
               );
            },
         ...
         return {
            ...
            isOutOfView() {
               ...
               let u = f((s = e.offset) != null ? s : 0),
                  c = new Ge(f(0, 0).sub(u), f(F(), G()).add(u));
               return !Ut(this.screenArea(), c);
            },
            onExitView(u) {
      ...
      function fi(e = {}) {
         return typeof e == "number"
            ? (B("clean(time)", "cleanup({ delay: time })"),
              D(P({}, Vt({ destroy: !0, delay: e })), { id: "cleanup" }))
            : D(
                 P(
                    {},
                    Vt({
      ...
      function pi(e = {}) {
         ...
         return {
            id: "area",
            add() {
               this.area.cursor && this.onHover(() => vn(this.area.cursor));
            },
            area: {
               shape: "rect",
            ...
            hasPoint(c) {
               return yt(this.worldArea(), c);
            },
            pushOut(c) {
               var g;
               if (
                  c === this ||
                  ((g = c.area) == null ? void 0 : g.shape) !== "rect"
               )
                  return null;
               let s = this.worldArea(),
                  o = c.worldArea(),
            ...
            worldArea() {
               ...
               let o = f((y = this.scale) != null ? y : 1).scale(
                  this.area.scale
               );
               (c *= o.x), (s *= o.y);
               let d = $e(this.origin || je),
            ...
            screenArea() {
               ...
               return this.fixed
                  ? c
                  : { shape: "rect", p1: it(c.p1), p2: it(c.p2) };
            },
         };
      }
      a(pi, "area");
               ...
               play(o, d = {}) {
                  ...
                  u && this.stop(),
                     (u = {
                        ...
                        timer: 0,
                        loop:
                           (g = (m = d.loop) != null ? m : h.loop) != null
                              ? g
                              : !1,
                        pingpong:
                           (x = (y = d.pingpong) != null ? y : h.pingpong) !=
                           null
                              ? x
                              : !1,
                        speed:
                           (O = (W = d.speed) != null ? W : h.speed) != null
                              ? O
                              : 10,
      ...
      function mi(e, n = {}) {
         function r(u) {
            ...
            return (
               (u.width =
                  c.width / (((s = u.scale) == null ? void 0 : s.x) || 1)),
               (u.height =
                  c.height / (((o = u.scale) == null ? void 0 : o.y) || 1)),
               c
            );
         }
         return (
      ...
      function gi(e, n) {
         return {
            ...
            draw() {
               pe(
                  D(P({}, De(this)), { width: this.width, height: this.height })
               );
            },
            inspect() {
               return `${Math.ceil(this.width)}, ${Math.ceil(this.height)}`;
      ...
      function Ui(e) {
         return {
            ...
            radius: e,
            draw() {
               Rt(D(P({}, De(this)), { radius: this.radius }));
            },
            inspect() {
      ...
      function vi(e = {}) {
         ...
         return {
            id: "body",
            require: ["pos", "area"],
            jumpForce: (s = e.jumpForce) != null ? s : bi,
            ...
            update() {
               ...
               if (r) {
                  ...
                  !r.exists() || x !== W || M < ee || O > te
                     ...
                     : u &&
                       r.pos &&
                       ((this.pos = this.pos.add(r.pos.sub(u))),
                       (u = r.pos.clone()));
               }
               if (!r) {
                  let g = this.move(0, n);
                  if (g)
                     if (g.isBottom()) {
                        ...
                        g.isTop() &&
                           ((n = 0), this.trigger("headbutt", g.target));
                  (n += kn() * this.weight * Z()),
                     (n = Math.min(n, (m = e.maxVel) != null ? m : xi));
               }
            },
            curPlatform() {
               return r;
         ...
         return (
            ...
            s.start(),
            {
               ...
               download(d = "kaboom.mp4") {
                  (s.onstop = () => {
                     cr(new Blob(o, { type: "video/mp4" }), d);
                  }),
                     s.stop(),
                     w.masterNode.disconnect(r),
                     n.getTracks().forEach((h) => h.stop());
      ...
      let Xn = null,
         Kn = null;
      J(null, qr).then((e) => (Xn = e)), J(null, Pr).then((e) => (Kn = e));
      function Gi(e, n = {}) {
         var o, d;
         let r = (n.speed || 1) * 5,
            u = n.scale || 1,
      ...
      function _i() {
         let e = p.cam,
            n = L.fromAngle(_e(0, 360)).scale(e.shake);
         (e.shake = Fe(e.shake, 0, 5 * Z())),
            (e.transform = new R()
               .translate(at())
               .scale(e.scale)
               .rotateZ(e.angle)
...
`),
      ...
      function Qn(e) {
         let n = a((r) => {
            ...
            (t.realTime = u),
               t.skipTime ||
                  ((t.dt = c), (t.time += t.dt), t.fpsCounter.tick(t.dt)),
               (t.skipTime = !1),
               t.numFrames++,
               e();
            for (let s in t.keyStates) t.keyStates[s] = Gr(t.keyStates[s]);
            for (let s in t.mouseStates)
               t.mouseStates[s] = Gr(t.mouseStates[s]);
            (t.charInputted = []),
               (t.isMouseMoved = !1),
               (t.isKeyPressed = !1),
      ...
      let ye = {
         ...
         WHITE: v.WHITE,
         BLACK: v.BLACK,
         keyIsDown: T("keyIsDown()", "isKeyDown()", Lt),
         keyIsPressed: T("keyIsPressed()", "isKeyPressed()", Le),
         keyIsPressedRep: T("keyIsPressedRep()", "isKeyPressedRepeat()", Mt),
         keyIsReleased: T("keyIsReleased()", "isKeyReleased()", nt),
         mouseIsDown: T("mouseIsDown()", "isMouseDown()", et),
         mouseIsClicked: T("mouseIsClicked()", "isMousePressed()", Me),
         mouseIsReleased: T("mouseIsReleased()", "isMouseReleased()", tt),
         mouseIsMoved: T("mouseIsMoved()", "isMouseMoved()", Wt),
         dir: T("dir()", "Vec2.fromAngle()", L.fromAngle),
         action: T("action()", "onUpdate()", Pe),
         render: T("render()", "onDraw()", Sn),
         collides: T("collides()", "onCollide()", Cn),
         clicks: T("clicks()", "onClick()", Rn),
         hovers: T("hovers()", "onHover()", Wn),
         keyDown: T("keyDown()", "onKeyDown()", Pt),
         keyPress: T("keyPress()", "onKeyPress()", H),
         keyPressRep: T("keyPressRep()", "onKeyPressRepeat()", Dt),
         keyRelease: T("keyRelease()", "onKeyRelease()", At),
         mouseDown: T("mouseDown()", "onMouseDown()", Ln),
         mouseClick: T("mouseClick()", "onMousePress()", Ot),
         mouseRelease: T("mouseRelease()", "onMouseRelease()", qn),
         mouseMove: T("mouseMove()", "onMouseMove()", Pn),
         charInput: T("charInput()", "onCharInput()", Dn),
         touchStart: T("touchStart()", "onTouchStart()", An),
         touchMove: T("touchMove()", "onTouchMove()", On),
         touchEnd: T("touchEnd()", "onTouchEnd()", In),
         focused: T("focused()", "isFocused()", Yn),
         ready: T("ready()", "onLoad()", Ue),
      };
      if ((i.plugins && i.plugins.forEach(Nn), i.global !== !1))
